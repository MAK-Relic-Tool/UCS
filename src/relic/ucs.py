...
def lang_code_to_name(lang_code: str) -> Optional[str]:
    ...
    :return: The name used to mark UCS files.
    """
...
def walk_ucs(folder: StrOrPathLike, lang_code: Optional[str] = None) -> Iterable[StrOrPathLike]:
    ...
    :return: An iterable collection of all UCS file paths.
    """
...
class LangEnvironment(UcsDict):
    ...
    def load_environment(cls,
        ...
        :return: The created Language Environment.
        """
    ...
    def read(self, file: StrOrPathLike) -> None:
        ...
        :return: Nothing, the environment is updated in-place.
        """
...
def get_lang_string_for_file(environment: Union[LangEnvironment, LangFile], file_path: str) -> str:
    ...
    :return: The subtitles in the requested language.
    """
